...
const NylasClient = require("./Nylas");
const _ = require("./Helpers");
const fs = require("fs");
const path = require("path");

const createDraftEmail = async ({ email, firstName, personalizedLine }) => {
...
<a href="https://www.ogroof.com">OGroof.com</a>
    ...
    const pdfPath = path.join(
        __dirname,
        "../assets/pdf/Ocean Group Construction - Marketing PDF.pdf"
    );
    ...
    const emailData = {
        subject: "LinkedIn Connection - Roofing",
        to: [{ email }],
        body,
...
module.exports = createDraftEmail;
